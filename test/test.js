...
class MoveManager {
    ...
    move(delta) {
        switch (this.node.tagName) {
            case "circle":
            case "ellipse":
                this.root.of(this.node).attrFn("cx", origin => String(+utils_1.nonUndefined(origin, "0") + delta[0]));
                this.root.of(this.node).attrFn("cy", origin => String(+utils_1.nonUndefined(origin, "0") + delta[1]));
                break;
            case "image":
            case "text":
            case "rect":
            case "use":
                this.root.of(this.node).attrFn("x", origin => String(+utils_1.nonUndefined(origin, "0") + delta[0]));
                this.root.of(this.node).attrFn("y", origin => String(+utils_1.nonUndefined(origin, "0") + delta[1]));
                break;
            case "line":
                this.root.of(this.node).attrFn("x1", origin => String(+utils_1.nonUndefined(origin, "0") + delta[0]));
                this.root.of(this.node).attrFn("y1", origin => String(+utils_1.nonUndefined(origin, "0") + delta[1]));
                this.root.of(this.node).attrFn("x2", origin => String(+utils_1.nonUndefined(origin, "0") + delta[0]));
                this.root.of(this.node).attrFn("y2", origin => String(+utils_1.nonUndefined(origin, "0") + delta[1]));
                break;
            case "polygon":
            case "polyline":
                let pointsAttr = this.root.of(this.node).attr("points");
                ...
                this.root.of(this.node).attr("points", points.map(p => p.join(" ")).join(", "));
                break;
            case "path":
                let dAttr = this.root.of(this.node).attr("d");
                ...
                this.root.of(this.node).attr("d", parsers_1.genD(d));
                break;
            default:
                break;
        }
...
},{"./Option":2,"./Vec2":6,"./parsers":15,"./utils":19}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
class Option {
    constructor(content) {
...
},{"./MoveManager":1,"./SizeManager":4,"./SvgManager":5,"./index":14}],4:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
const index_1 = require("./index");
class SizeManager {
    constructor(root, node) {
     ...
     */
    zoom(vec2) {
        let center = this.root.of(this.node).center();
        switch (this.node.tagName) {
            case "circle":
                this.root.of(this.node).attrFn("r", origin => index_1.optional(origin).map(c => String(+c * vec2[0])).content);
                break;
            case "ellipse":
                this.root.of(this.node).attrFn("rx", origin => index_1.optional(origin).map(c => String(+c * vec2[0])).content);
                this.root.of(this.node).attrFn("ry", origin => index_1.optional(origin).map(c => String(+c * vec2[1])).content);
                break;
            case "text":
                this.root.of(this.node).attrFn("font-size", origin => index_1.optional(origin).map(c => String(+c * vec2[0])).content);
                break;
            case "rect":
            case "use":
                this.root.of(this.node).attrFn("width", origin => index_1.optional(origin).map(c => String(+c * vec2[0])).content);
                this.root.of(this.node).attrFn("height", origin => index_1.optional(origin).map(c => String(+c * vec2[1])).content);
                break;
            case "line":
                center = this.root.of(this.node).center();
                this.root.of(this.node).attrFn("x2", origin => index_1.optional(origin).map(c => String(+c * vec2[0])).content);
                this.root.of(this.node).attrFn("y2", origin => index_1.optional(origin).map(c => String(+c * vec2[1])).content);
                break;
            case "polygon":
            case "polyline":
                center = this.root.of(this.node).center();
            ...
            case "path":
                ...
                this.root.of(this.node).attr("d", index_1.genD(d));
                break;
            default:
                break;
        }
        this.root.of(this.node).center(center);
    }
}
...
},{"./Option":2,"./Vec2":6,"./index":14,"./transform":17,"./transform/transforms":18,"./utils":19,"tinycolor2":20}],6:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
function add(a, b) {
...
},{"./Matrix3":8}],8:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Vec3":9}],9:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Affine":7,"./Vec3":9}],11:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
function merge(a, b) {
    return {
...
class CollectionManager {
    ...
    zoom(ratio) {
        ...
        this.svgs.forEach(s => {
            ...
            let indivisual = this.root.of(s).center();
            this.root.of(s).center(index_1.add(index_1.muldot(indivisual, ratio), index_1.muldot(center, index_1.sub([1, 1], ratio))));
        });
    }
    size(vec2) {
        if (vec2 === undefined) {
...
},{"../index":14,"./Box":11}],13:[function(require,module,exports){
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Box":11,"./CollectionManager":12}],14:[function(require,module,exports){
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Option":2,"./SvgManager":5,"./Vec2":6,"./affine":10,"./collection":13,"./parsers":15,"./utils":19}],15:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"yaparsec":23}],16:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
let root = RootManager_1.svg(document.getElementById("svg"));
log("1", root.of(circle).center());
log("2", root.of(circle2).leftTop());
log("3", root.of(circle3).rightBottom());
log("box", root.collectionof([circle, circle2, circle3]).center());
root.collectionof([circle, circle2, circle3]).size([200, 400]);

},{"./RootManager":3}],17:[function(require,module,exports){
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../index":14,"../utils":19}],19:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
